...
- لا تختلق أو تخمّن أرقاماً. إن لم تتأكد من معلومة (مثل لزوجة الزيت)، اترك الحقل فارغاً سلسلة نصية فارغة "" بدل إعطاء قيمة خاطئة.
...
- أعطِ ملاحظات عملية تخدم السائق: البطارية الصغيرة، مقاس الإطار، زيت الناقل، ونصيحة صيانة مختصرة.
...
[
  {{
    ...
    "engine_code": "كود المحرك أو فارغة",
    "fuel": "الوقود",
